...
import java.util.*;
import javax.swing.*;
/**@ brief GUI interface for supervisor to send log request to GM*/

 class sendLogsup extends JFrame
{
	...
	filegminventory fgi;
	dept d;int att;
	public sendLogsup(filegminventory fgi,dept d)
	{
		newFrame = new JFrame();
		this.d=d;
	...
	{
		gminventory  ss=new gminventory();
